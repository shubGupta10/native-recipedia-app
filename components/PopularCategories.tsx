...
const PopularCategories = () => {
    return (
        <View className='flex-col p-5'>
            <Text style={{ fontSize: 18, fontWeight: '700', marginBottom: 8, color: COLORS.textPrimary }}>Categories</Text>
                ...
                {categories.map((cat) => (
                    <View
                        ...
                        <Image
                            ...
                            transition={300}
                        />
                        <Text style={{ marginTop: 4, fontSize: 14, color: COLORS.textPrimary }}>{cat.title}</Text>
                    </View>
                ))}
            </ScrollView>
        </View>
